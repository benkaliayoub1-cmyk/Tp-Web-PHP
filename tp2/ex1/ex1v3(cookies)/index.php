        ...
        <div class="col-md-10 col-lg-8">
            <div class="alert alert-dark" role="alert"><h1> Contactez-nous ! </h1></div>
             ...
             <form method="post" action="traitement.php">
                <div class="mb-3">
                      <label for="nom" class="form-label">Nom :<span class="text-danger"> * <?= $erreurs['nom'] ?></span></label>
                      <input type="text" class="form-control" id="nom" name="nom" placeholder="Entrez votre nom & prénom"><br>
        
                </div>
                <div class="mb-3">
                      <label for="email" class="form-label">Email :<span class="text-danger"> * <?= $erreurs['email'] ?></span></label>
                ...
                <div class="mb-3">
                       <label for="message" class="form-label">Votre Message :<span class="text-danger"> * <?= $erreurs['message']  ?></span></label>
